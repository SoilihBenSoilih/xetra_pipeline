...
class TestXetraTransformerETLMethods(unittest.TestCase):
    """
    Testing the transformers class.
    """
    ...
    def setUp(self):
        ...
        self.s3_bucket_src.write_df_to_s3(self.df_src.loc[1:1], '2021-04-16/2021-04-16_BINS_XETR15.csv','csv')
        ...
        self.s3_bucket_src.write_df_to_s3(self.df_src.loc[4:4], '2021-04-18/2021-04-18_BINS_XETRO7.csv','csv')
        self.s3_bucket_src.write_df_to_s3(self.df_src.loc[5:5], '2021-04-18/2021-04-18_BINS_XETRO8.csv','csv')
        self.s3_bucket_src.write_df_to_s3(self.df_src.loc[6:6], '2021-04-19/2021-04-19_BINS_XETRO7.csv','csv')
        self.s3_bucket_src.write_df_to_s3(self.df_src.loc[7:7], '2021-04-19/2021-04-19_BINS_XETRO8.csv','csv')
        ...
        data_report = [
            ['AT0000A0E9W5', '2021-04-17', 20.21, 18.27, 18.21, 21.34, 1088, np.nan],
    ...
    def test_transform_report1_emptydf(self):
        ...
        """
        # Expected results
        log_exp = 'The dataframe is empty. No transformations will be applied.' # Test init
        extract_date = '2021-04-17'
